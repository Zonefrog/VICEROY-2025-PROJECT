#!/usr/bin/env python3
"""
Simple script to run the complete pipeline with original settings
"""
...
2.4. Watermarking LLM content"""
    ...
    try:
        ...
        print_("✅ Starting pipeline execution...")
        
        # Execute Steps 1-4.5
        initial_topics = core.execute_step_1(generation_context)
        print_(f"✅ Step 1: Generated {len(initial_topics)} initial topics")
        
        step_2_result = core.execute_step_2(generation_context, initial_topics)
        print_(f"✅ Step 2: Researched topics")
        
        step_3_result = core.execute_step_3(generation_context, initial_topics, step_2_result)
        print_(f"✅ Step 3: Generated {len(step_3_result)} additional topics")
        
        step_4_result = core.execute_step_4(generation_context, step_3_result)
        print_(f"✅ Step 4: Researched additional topics")
        
        step_4_5_result = core.execute_step_4_5(generation_context, initial_topics, step_3_result, step_2_result, step_4_result)
